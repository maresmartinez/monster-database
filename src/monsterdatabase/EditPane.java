...
public class EditPane extends GridPane {
    ...
    // Buttons
    protected final Button btSave = new Button("Save Changes");
    ...
    public EditPane() {
       ...
       // Label Heading
       Label lblHeading = new Label("Edit Monster");
       ...
       // Style Buttons
       btSave.setPrefWidth(300);
       HBox paneForButtons = new HBox(20);
       paneForButtons.getChildren().addAll(btSave, btCancel);
